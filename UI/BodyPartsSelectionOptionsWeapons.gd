...
onready var weapon = get_node("MarginContainer/VBoxContainer/VBoxContainer/WeaponBasic")
...
func load_limb(count):
	weapon.load_weapon(count)
	title.text = weapon.stats.part_name
	description.text = weapon.stats.part_description
